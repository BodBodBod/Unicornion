В ноутбуке рассмотрен датасет forestfires о возгараниях лесов в португальском парке Monteshino.
Цель работы: посмотреть на качество линейной регрессии в ситуации с определенными трудностями в данных.

Readme с описанием датафрейма от авторов:
Citation Request:
...
2. Sources
   Created by: Paulo Cortez and Anнbal Morais (Univ. Minho) @ 2007
